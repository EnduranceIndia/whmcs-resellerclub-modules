...
global $orderbox;
$orderbox =  new orderboxapi( $resellerclub_config['resellerid'] , $resellerclub_config['password'] , 'rc-whmcs-resellerclubsdhosting-uk' );
...
function resellerclubsdhostinguk_ConfigOptions() {
    ...
    if( array_key_exists( 'singledomainhostinglinuxuk', $plans )  ) {
    ...
    if( array_key_exists( 'singledomainhostingwindowsuk', $plans )  ) {
...
//            logModuleCall('resellerclubsdhostinguk', 'suspend', array( 'api' => $api_path_orderid_from_domain, 'domain-name' => $params['domain'] ), $response , $order_id_result );
...
//                logModuleCall('resellerclubsdhostinguk', 'suspend', array( 'api'  =>  '/orders/suspend.json',  'order-id' => $order_id , 'reason' => $params['suspendreason'] ), $response , $order_unsuspend_result );
...
function resellerclubsdhostinguk_UnsuspendAccount( $params  ) {
    ...
    try {
        ...
        if( is_array( $order_id_result ) && array_key_exists( 'status', $order_id_result ) && strtolower( $order_id_result['status'] ) == 'error'  ) {
//            logModuleCall('resellerclubsdhostinguk', 'unsuspend', array( 'api' => $api_path_orderid_from_domain, 'domain-name' => $params['domain'] ), $response , $order_id_result );
            return $order_id_result['message'];
        } else {
            $order_id = $order_id_result;
...
//                logModuleCall('resellerclubsdhostinguk', 'unsuspend', array( 'api'  =>  '/orders/unsuspend.json',  'order-id' => $order_id ), $response , $order_unsuspend_result );
