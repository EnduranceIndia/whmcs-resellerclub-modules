...
/**
 * WHMCS Module for Resellerclub's Single Domain Hosting - USA ( Linux / Windows )
 */
// AddOn Module Name
...
$orderbox = new orderboxapi($resellerclub_config['resellerid'], $resellerclub_config['apikey'],$resellerclub_config['enable_log'],'rc-whmcs-resellerclubsdhosting-us');

/**
 * WHMCS provisional module core functions
 */
function resellerclubsdhostingus_ConfigOptions() {

    global $orderbox;
    $hosting_plan_names = array();
    $active_products = $orderbox->api('GET', '/products/category-keys-mapping.json', array(), $response, 'resellerclubsdhostingus', 'configoptions');

    if (in_array('singledomainhostinglinuxus', $active_products['hosting']) || in_array('singledomainhostingwindowsus', $active_products['hosting'])) {
        $plans = $orderbox->api('GET', '/products/plan-details.json', array(), $response, 'resellerclubsdhostingus', 'configoptions');

        if (array_key_exists('singledomainhostinglinuxus', $plans) && in_array('singledomainhostinglinuxus', $active_products['hosting'])) {
            $hosting_plans = $plans['singledomainhostinglinuxus'];
        ...
        if (array_key_exists('singledomainhostingwindowsus', $plans) && in_array('singledomainhostingwindowsus', $active_products['hosting'])) {
            $hosting_plans = $plans['singledomainhostingwindowsus'];
            foreach ($hosting_plans as $plan_id => $plan) {
                if ('Active' == $plan['status']) {
...
function resellerclubsdhostingus_CreateAccount($params) {

    global $orderbox;

    try {
        $client_details = $orderbox->api('GET', '/customers/details.json', array('username' => $params['clientsdetails']['email']), $response, 'resellerclubsdhostingus', 'create');
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_order_add = '/singledomainhosting/windows/us/add.json';
        } else {
            $api_path_order_add = '/singledomainhosting/linux/us/add.json';
        }

        $order_api_result = $orderbox->api('POST', $api_path_order_add, $order_details, $response, 'resellerclubsdhostingus', 'create');
        ...
        logModuleCall('resellerclubsdhostingus', 'create', 'unknown', 'Exception : ' . $e->getMessage());
        return "Customer sign up error - " . $e->getMessage();
    }
}

function resellerclubsdhostingus_SuspendAccount($params) {
    ...
    try {
        $plan_pieces = _get_plan_details($params['configoption1']);
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/singledomainhosting/windows/us/orderid.json';
        } else {
            $api_path_orderid_from_domain = '/singledomainhosting/linux/us/orderid.json';
        }

        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubsdhostingus', 'suspend');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_suspend_result = $orderbox->api('POST', '/orders/suspend.json', array('order-id' => $order_id, 'reason' => $params['suspendreason']), $response, 'resellerclubsdhostingus', 'suspend');
        ...
        logModuleCall('resellerclubsdhostingus', 'suspend', 'unknown', 'Exception : ' . $e->getMessage());
        return "Order suspend error - " . $e->getMessage();
    }
}

function resellerclubsdhostingus_UnsuspendAccount($params) {
    ...
    try {
        ...
        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubsdhostingus', 'unsuspend');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_unsuspend_result = $orderbox->api('POST', '/orders/unsuspend.json', array('order-id' => $order_id), $response, 'resellerclubsdhostingus', 'unsuspend');
        ...
        logModuleCall('resellerclubsdhostingus', 'unsuspend', 'unknown', 'Exception : ' . $e->getMessage());
        return "Order unsuspend error - " . $e->getMessage();
    }
}

function resellerclubsdhostingus_TerminateAccount($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/singledomainhosting/windows/us/orderid.json';
            $api_path_order_delete = '/singledomainhosting/windows/us/delete.json';
        } else {
            $api_path_orderid_from_domain = '/singledomainhosting/linux/us/orderid.json';
            $api_path_order_delete = '/singledomainhosting/linux/us/delete.json';
        }


        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubsdhostingus', 'terminate');

        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            return $order_id_result['message'];
        } else {
            $order_id = $order_id_result;
            $order_delete_result = $orderbox->api('POST', $api_path_order_delete, array('order-id' => $order_id), $response, 'resellerclubsdhostingus', 'terminate');
...
function resellerclubsdhostingus_Renew($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/singledomainhosting/windows/us/orderid.json';
            $api_path_order_renew = '/singledomainhosting/windows/us/renew.json';
        } else {
            $api_path_orderid_from_domain = '/singledomainhosting/linux/us/orderid.json';
            $api_path_order_renew = '/singledomainhosting/linux/us/renew.json';
        }

        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubsdhostingus', 'renew');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_api_result = $orderbox->api('POST', $api_path_order_renew, $order_details, $response, 'resellerclubsdhostingus', 'renew');
...
function resellerclubsdhostingus_manualrenew($params) {

    //Renew the order
    $renew_result = resellerclubsdhostingus_Renew($params);
...
function resellerclubsdhostingus_ChangePackage($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/singledomainhosting/windows/us/orderid.json';
            $api_path_order_modify = '/singledomainhosting/windows/us/modify.json';
        } else {
            $api_path_orderid_from_domain = '/singledomainhosting/linux/us/orderid.json';
            $api_path_order_modify = '/singledomainhosting/linux/us/modify.json';
        }
        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubsdhostingus', 'changepackage');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_api_result = $orderbox->api('POST', $api_path_order_modify, $order_details, $response, 'resellerclubsdhostingus', 'changepackage');
...
function resellerclubsdhostingus_ClientAreaCustomButtonArray() {
    
}

function resellerclubsdhostingus_AdminCustomButtonArray() {
    return array("Execute Manual Renew" => "manualrenew");
}

function resellerclubsdhostingus_ClientArea($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/singledomainhosting/windows/us/orderid.json';
            $api_path_order_details = '/singledomainhosting/windows/us/details.json';
            $api_path_dns_details = '/singledomainhosting/windows/us/dns-record.json';
        } else {
            $api_path_orderid_from_domain = '/singledomainhosting/linux/us/orderid.json';
            $api_path_order_details = '/singledomainhosting/linux/us/details.json';
            $api_path_dns_details = '/singledomainhosting/linux/us/dns-record.json';
        }

        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubsdhostingus', 'clientarea');

        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            $is_processing = true;
        } else {
            $order_id = $order_id_result;
            $order_details = $orderbox->api('GET', $api_path_order_details, array('order-id' => $order_id), $response, 'resellerclubsdhostingus', 'clientarea');
            $order_dns_details = $orderbox->api('GET', $api_path_dns_details, array('order-id' => $order_id), $response, 'resellerclubsdhostingus', 'clientarea');
        }
...
function resellerclubsdhostingus_LoginLink($params) {
...
if (!function_exists('_createCustomer')) {
    ...
    function _createCustomer($params) {
        ...
        $create_customer_result = $orderbox->api('POST', '/customers/signup.json', $customer_details, $response_headers, 'resellerclubsdhostingus', 'create');
...
if (!function_exists('_get_control_panel_link')) {
    ...
    function _get_control_panel_link($params) {
        ...
        $client_details = $orderbox->api('GET', '/customers/details.json', array('username' => $params['clientsdetails']['email']), $response, 'resellerclubsdhostingus', 'clientarea');
        if (is_array($client_details) && strtolower($client_details['status']) == 'error') {
            $error = "Customer ({$params['clientsdetails']['email']}) not found at Resellerclub";
        } else {
            $customer_id = $client_details['customerid'];
            $customer_temp_password = $orderbox->api('GET', '/customers/temp-password.json', array('customer-id' => $customer_id), $response, 'resellerclubsdhostingus', 'clientarea');
        ...
        if ($error == '') {
            ...
            $reseller_details = $orderbox->api('GET', '/resellers/details.json', array(), $response, 'resellerclubsdhostingus', 'clientarea');
        ...
        if ($error == '') {
            ...
            $authentication_token_result = $orderbox->api('GET', '/customers/generate-token.json', array('username' => $params['clientsdetails']['email'], 'passwd' => $resellerclub_customer_password, 'ip' => $ip), $response, 'resellerclubsdhostingus', 'clientarea');
