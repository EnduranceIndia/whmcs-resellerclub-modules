...
/**
 * WHMCS Module for Resellerclub's Multi Domain Hosting - UK ( Linux / Windows )
 */
// AddOn Module Name
 ...
 */
global $orderbox;
$orderbox = new orderboxapi($resellerclub_config['resellerid'], $resellerclub_config['apikey'], $resellerclub_config['enable_log'], 'rc-whmcs-resellerclubmdhosting-uk');

/**
 * WHMCS provisional module core functions
 */
function resellerclubmdhostinguk_ConfigOptions() {

    global $orderbox;
    $hosting_plan_names = array();
    $active_products = $orderbox->api('GET', '/products/category-keys-mapping.json', array(), $response, 'resellerclubmdhostinguk', 'configoptions');

    if (in_array('multidomainhostinglinuxuk', $active_products['hosting']) || in_array('multidomainwindowshostinguk', $active_products['hosting'])) {
        $plans = $orderbox->api('GET', '/products/plan-details.json', array(), $response, 'resellerclubmdhostinguk', 'configoptions');

        if (array_key_exists('multidomainhostinglinuxuk', $plans) && in_array('multidomainhostinglinuxuk', $active_products['hosting'])) {
            $hosting_plans = $plans['multidomainhostinglinuxuk'];
            foreach ($hosting_plans as $plan_id => $plan) {
                $hosting_plan_names[] = 'Linux ' . ' - ' . $plan['plan_name'] . ' - ' . $plan_id;
            }
        }
        if (array_key_exists('multidomainwindowshostinguk', $plans) && in_array('multidomainwindowshostinguk', $active_products['hosting'])) {
            $hosting_plans = $plans['multidomainwindowshostinguk'];
            foreach ($hosting_plans as $plan_id => $plan) {
...
function resellerclubmdhostinguk_CreateAccount($params) {

    global $orderbox;

    try {
        $client_details = $orderbox->api('GET', '/customers/details.json', array('username' => $params['clientsdetails']['email']), $response, 'resellerclubmdhostinguk', 'create');
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_order_add = '/multidomainhosting/windows/uk/add.json';
        } else {
            $api_path_order_add = '/multidomainhosting/linux/uk/add.json';
        }

        $order_api_result = $orderbox->api('POST', $api_path_order_add, $order_details, $response, 'resellerclubmdhostinguk', 'create');
        ...
        logModuleCall('resellerclubmdhostinguk', 'create', 'unknown', 'Exception : ' . $e->getMessage());
        return "Customer sign up error - " . $e->getMessage();
    }
}

function resellerclubmdhostinguk_SuspendAccount($params) {
    ...
    try {
        $plan_pieces = _get_plan_details($params['configoption1']);
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/multidomainhosting/windows/uk/orderid.json';
        } else {
            $api_path_orderid_from_domain = '/multidomainhosting/linux/uk/orderid.json';
        }

        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubmdhostinguk', 'suspend');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_suspend_result = $orderbox->api('POST', '/orders/suspend.json', array('order-id' => $order_id, 'reason' => $params['suspendreason']), $response, 'resellerclubmdhostinguk', 'suspend');
        ...
        logModuleCall('resellerclubmdhostinguk', 'suspend', 'unknown', 'Exception : ' . $e->getMessage());
        return "Order suspend error - " . $e->getMessage();
    }
}

function resellerclubmdhostinguk_UnsuspendAccount($params) {
    ...
    try {
        ...
        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubmdhostinguk', 'unsuspend');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_unsuspend_result = $orderbox->api('POST', '/orders/unsuspend.json', array('order-id' => $order_id), $response, 'resellerclubmdhostinguk', 'unsuspend');
        ...
        logModuleCall('resellerclubmdhostinguk', 'unsuspend', 'unknown', 'Exception : ' . $e->getMessage());
        return "Order unsuspend error - " . $e->getMessage();
    }
}

function resellerclubmdhostinguk_TerminateAccount($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/multidomainhosting/windows/uk/orderid.json';
            $api_path_order_delete = '/multidomainhosting/windows/uk/delete.json';
        } else {
            $api_path_orderid_from_domain = '/multidomainhosting/linux/uk/orderid.json';
            $api_path_order_delete = '/multidomainhosting/linux/uk/delete.json';
        }


        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubmdhostinguk', 'terminate');

        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            return $order_id_result['message'];
        } else {
            $order_id = $order_id_result;
            $order_delete_result = $orderbox->api('POST', $api_path_order_delete, array('order-id' => $order_id), $response, 'resellerclubmdhostinguk', 'terminate');
...
function resellerclubmdhostinguk_Renew($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/multidomainhosting/windows/uk/orderid.json';
            $api_path_order_renew = '/multidomainhosting/windows/uk/renew.json';
        } else {
            $api_path_orderid_from_domain = '/multidomainhosting/linux/uk/orderid.json';
            $api_path_order_renew = '/multidomainhosting/linux/uk/renew.json';
        }

        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubmdhostinguk', 'renew');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_api_result = $orderbox->api('POST', $api_path_order_renew, $order_details, $response, 'resellerclubmdhostinguk', 'renew');
...
function resellerclubmdhostinguk_manualrenew($params) {

    //Renew the order
    $renew_result = resellerclubmdhostinguk_Renew($params);
...
function resellerclubmdhostinguk_ChangePackage($params) {
    global $orderbox;
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/multidomainhosting/windows/uk/orderid.json';
            $api_path_order_modify = '/multidomainhosting/windows/uk/modify.json';
        } else {
            $api_path_orderid_from_domain = '/multidomainhosting/linux/uk/orderid.json';
            $api_path_order_modify = '/multidomainhosting/linux/uk/modify.json';
        }
        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubmdhostinguk', 'changepackage');
        ...
        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            ...
            $order_api_result = $orderbox->api('POST', $api_path_order_modify, $order_details, $response, 'resellerclubmdhostinguk', 'changepackage');
...
function resellerclubmdhostinguk_ClientAreaCustomButtonArray() {
    
}

function resellerclubmdhostinguk_AdminCustomButtonArray() {
    return array("Execute Manual Renew" => "manualrenew");
}

function resellerclubmdhostinguk_ClientArea($params) {
    ...
    try {
        ...
        if ('windows' == $plan_pieces['type']) {
            $api_path_orderid_from_domain = '/multidomainhosting/windows/uk/orderid.json';
            $api_path_order_details = '/multidomainhosting/windows/uk/details.json';
            $api_path_dns_details = '/multidomainhosting/windows/uk/dns-record.json';
        } else {
            $api_path_orderid_from_domain = '/multidomainhosting/linux/uk/orderid.json';
            $api_path_order_details = '/multidomainhosting/linux/uk/details.json';
            $api_path_dns_details = '/multidomainhosting/linux/uk/dns-record.json';
        }

        $order_id_result = $orderbox->api('GET', $api_path_orderid_from_domain, array('domain-name' => $params['domain']), $response, 'resellerclubmdhostinguk', 'clientarea');

        if (is_array($order_id_result) && array_key_exists('status', $order_id_result) && strtolower($order_id_result['status']) == 'error') {
            $is_processing = true;
        } else {
            $order_id = $order_id_result;
            $order_details = $orderbox->api('GET', $api_path_order_details, array('order-id' => $order_id), $response, 'resellerclubmdhostinguk', 'clientarea');
            $order_dns_details = $orderbox->api('GET', $api_path_dns_details, array('order-id' => $order_id), $response, 'resellerclubmdhostinguk', 'clientarea');
        }
...
function resellerclubmdhostinguk_LoginLink($params) {
...
if (!function_exists('_createCustomer')) {
    ...
    function _createCustomer($params) {
        ...
        $create_customer_result = $orderbox->api('POST', '/customers/signup.json', $customer_details, $response_headers, 'resellerclubmdhostinguk', 'create');
...
if (!function_exists('_get_control_panel_link')) {
    ...
    function _get_control_panel_link($params) {
        ...
        $client_details = $orderbox->api('GET', '/customers/details.json', array('username' => $params['clientsdetails']['email']), $response, 'resellerclubmdhostinguk', 'clientarea');
        if (is_array($client_details) && strtolower($client_details['status']) == 'error') {
            $error = "Customer ({$params['clientsdetails']['email']}) not found at Resellerclub";
        } else {
            $customer_id = $client_details['customerid'];
            $customer_temp_password = $orderbox->api('GET', '/customers/temp-password.json', array('customer-id' => $customer_id), $response, 'resellerclubmdhostinguk', 'clientarea');
        ...
        if ($error == '') {
            ...
            $reseller_details = $orderbox->api('GET', '/resellers/details.json', array(), $response, 'resellerclubmdhostinguk', 'clientarea');
        ...
        if ($error == '') {
            ...
            $authentication_token_result = $orderbox->api('GET', '/customers/generate-token.json', array('username' => $params['clientsdetails']['email'], 'passwd' => $resellerclub_customer_password, 'ip' => $ip), $response, 'resellerclubmdhostinguk', 'clientarea');
